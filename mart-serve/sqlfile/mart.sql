...
CREATE DATABASE IF NOT EXISTS `mart` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `mart`;
...
INSERT INTO `address` (`aid`, `auser`, `mobile`, `province`, `city`, `county`, `street`, `uid`) VALUES
	...
	('c12fbdb9879a0be46010', '荒草', '13203698521', '河北省', '唐山市', '市辖区', '呵呵哒', '2c9bffbb9765135af6eb'),
	('dba8ac55e7840f591ce3', '黄超的儿子666', '13203970970', '辽宁省', '营口市', '北宁市', '鹤岗市鸡东县鹤岗市麻山区西长位村', '2c9bffbb9765135af6eb'),
...
CREATE TABLE IF NOT EXISTS `avatar` (
  `aid` varchar(20) NOT NULL COMMENT '头像id',
  `uid` varchar(20) NOT NULL COMMENT '用户id',
  `imgUrl` varchar(200) NOT NULL COMMENT '头像路径',
  PRIMARY KEY  (`aid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='头像历史存储';

-- 正在导出表  mart.avatar 的数据：~14 rows (大约)
DELETE FROM `avatar`;
/*!40000 ALTER TABLE `avatar` DISABLE KEYS */;
INSERT INTO `avatar` (`aid`, `uid`, `imgUrl`) VALUES
	('094c3c5c34a03fa1af22', '2c9bffbb9765135af6eb', 'http://10.34.4.12:7001/public/upload/371c181a40821abc3af952c139b63426.jpg'),
	('0e193132b5a7ba7278ee', '2c9bffbb9765135af6eb', 'http://10.34.4.12:7001/public/upload/c4972613b70a810bf2ff3b8ebe138293.jpg'),
	('16c3ea34c3844367b830', '2c9bffbb9765135af6eb', 'http://10.34.4.12:7001/public/upload/54fc3996a33b7b7cdddf2b838ad2c312.jpg'),
	('3c5de7bbb5b3e088d5d8', '2c9bffbb9765135af6eb', 'http://10.34.4.12:7001/public/upload/d1c7b133a150e808bca296ccb60138bb.jpg'),
	('64e2097386bf79f22014', '2c9bffbb9765135af6eb', 'http://10.34.4.12:7001/public/upload/c17aa69ab8575e0e45bc56866c2384e8.jpg'),
	('7162947a4ca32455afa6', '2c9bffbb9765135af6eb', 'http://10.34.4.12:7001/public/upload/593e6c815a4292c034c119f454185d2a.jpg'),
	('7fb8b4b03668078dad1f', '2c9bffbb9765135af6eb', 'http://10.34.4.12:7001/public/upload/28e657a9c1c749e8a61f33afec5ad0e2.jpg'),
	('8d2e189e0d7cfc814166', '2c9bffbb9765135af6eb', 'http://10.34.4.12:7001/public/upload/f4a7021f7e0ead38062a4e977647d25a.jpg'),
	('a0032c088685416d76a9', '5f13db6cd93c32dfb37e', 'http://10.34.4.12:7001/public/upload/85dc7ad105f588109493025f860d2dac.jpg'),
	('bf30bbf341772f797b08', '2c9bffbb9765135af6eb', 'http://10.34.4.12:7001/public/upload/b440746504733f600cdbaa79ab6c34fe.jpg'),
	('ce7a6579bfe9072ac0b0', 'db2ad7d1f211f42225d3', 'http://10.34.4.12:7001/public/upload/e27232b1ea3ae97464fd5b545876dd74.jpg'),
	('e7e36f7929471ddfd3a4', '2c9bffbb9765135af6eb', 'http://10.34.4.12:7001/public/upload/748f9108cbbd4f4254f6f01ec00f42a3.jpg'),
	('f3171c2f1bcecb452574', 'db2ad7d1f211f42225d3', 'http://10.34.4.12:7001/public/upload/490616f8ada781c0baca2e11498050be.jpg'),
	('fb849400f5dc024ea9e1', '2c9bffbb9765135af6eb', 'http://localhost:7001/public/upload/fcdb0b75ae923c15500bc515ae2aeff9.jpg');
...
CREATE TABLE IF NOT EXISTS `carousel` (
  ...
  `start_time` char(50) default NULL COMMENT '轮播图-活动开始时间',
  `end_time` char(50) default NULL COMMENT '轮播图-活动活动结束时间',
  `img` varchar(500) default NULL COMMENT '轮播图-图片',
  `type` int(11) default '0' COMMENT '投放开关 0 关闭 1 开启',
  PRIMARY KEY  (`cid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='轮播图\r\n广告图';

-- 正在导出表  mart.carousel 的数据：~5 rows (大约)
DELETE FROM `carousel`;
/*!40000 ALTER TABLE `carousel` DISABLE KEYS */;
INSERT INTO `carousel` (`cid`, `tit`, `start_time`, `end_time`, `img`, `type`) VALUES
	('0290a561d1c8e5572fd2', '122222', '2023-06-27T01:46:54.691Z', '2023-06-29T01:46:58.710Z', NULL, 0),
	('0cedd35de04885c9828c', '12313', '2023-06-28T01:57:21.944Z', '2023-06-27T01:57:24.666Z', 'https://p1-q.mafengwo.net/s19/M00/CA/40/CoNBSGSb6dp1bWc3ACrZmTEJh-I.png?imageMogr2%2Fthumbnail%2F%21750x422r%2Fgravity%2FCenter%2Fcrop%2F%21750x422%2Fquality%2F90', 1),
	('0e842491a3bc7025008e', '测试活动标题', '2023-06-27T01:41:57.710Z', '2023-06-28T01:42:01.228Z', 'http://localhost:7001/public/upload/0db9ae33d494765faae65a3d83e49d3f.png', 0),
	('551d286d57186b623ccc', '测试活动标题', '2023-06-27T01:41:57.710Z', '2023-06-28T01:42:01.228Z', 'http://localhost:7001/public/upload/0db9ae33d494765faae65a3d83e49d3f.png', 0),
	('7e7fc691ffcca5be711e', '23', '2023-06-27T03:29:27.454Z', '2023-06-27T03:29:29.171Z', 'https://note.mafengwo.net/img/b6/2b/bbff39e550511e31a36a38a182a11c98.jpeg?imageMogr2%2Fthumbnail%2F%21450x270r%2Fstrip%2Fgravity%2FCenter%2Fcrop%2F%21450x270%2Fquality%2F90', 1);
...
-- 正在导出表  mart.comment 的数据：~6 rows (大约)
DELETE FROM `comment`;
/*!40000 ALTER TABLE `comment` DISABLE KEYS */;
INSERT INTO `comment` (`cid`, `pid`, `uid`, `uphoto`, `uname`, `comment`, `score`) VALUES
	('0022f3a276f56fd06099', '97f83f6c99e19ee73642', '2c9bffbb9765135af6eb', 'http://localhost:7001/public/upload/fcdb0b75ae923c15500bc515ae2aeff9.jpg', 'haonan', '66666', 4),
	('1305d630935bddd176b6', '97f83f6c99e19ee73642', '2c9bffbb9765135af6eb', 'http://localhost:7001/public/upload/fcdb0b75ae923c15500bc515ae2aeff9.jpg', 'haonan', '66666', 5),
	('2cf629cf23bc05af2461', '97f83f6c99e19ee73642', '2c9bffbb9765135af6eb', 'http://localhost:7001/public/upload/fcdb0b75ae923c15500bc515ae2aeff9.jpg', 'zhangsan', '777', 3),
	('2cf629cf23bc05af246d', '97f83f6c99e19ee73642', 'db2ad7d1f211f42225d3', 'http://10.34.4.12:7001/public/upload/490616f8ada781c0baca2e11498050be.jpg', 'heinan', '666', 5),
	('4217464d0ee8b09dfc16', '97f83f6c99e19ee73642', '2c9bffbb9765135af6eb', 'http://localhost:7001/public/upload/fcdb0b75ae923c15500bc515ae2aeff9.jpg', 'haonan', '66666', 4),
	('906df92a433881f576cb', '97f83f6c99e19ee73642', '2c9bffbb9765135af6eb', 'http://localhost:7001/public/upload/fcdb0b75ae923c15500bc515ae2aeff9.jpg', 'haonan', '66666', 3);
...
INSERT INTO `login` (`uid`, `username`, `password`, `identity_id`, `mobile`) VALUES
	('415c5c2bb32e40812b01', 'zhiqian', '8d969eef6ecad3c29a3a', 'f69d451429f41dbea7ed', '13031061118');
...
-- 正在导出表  mart.order 的数据：~7 rows (大约)
DELETE FROM `order`;
/*!40000 ALTER TABLE `order` DISABLE KEYS */;
INSERT INTO `order` (`oid`, `list`, `aid`, `uid`, `summary`, `total`, `status`) VALUES
	('0f0bbd6c948f345a533f', '[{"pid":"01a9f1043187f4e53568","count":1}]', 'dba8ac55e7840f591ce3', '2c9bffbb9765135af6eb', '1', '1', 4),
	('2f36f9a9b1cf9dbb5312', '[{"pid":"b2771f4cd290d92658e3","count":1}]', 'dba8ac55e7840f591ce3', '2c9bffbb9765135af6eb', '1', '1', 2),
	('5377df9deaa033235d81', '[{"pid":"b2771f4cd290d92658e3","count":1}]', '', '2c9bffbb9765135af6eb', '1', '1', 4),
	('635957ca357aeb354a39', '[{"pid":"7e47fb683ccbe4a92bf7","count":1}]', '', 'db2ad7d1f211f42225d3', '1', '1', 2),
	('85a286a087d0622cb995', '[{"pid":"7e47fb683ccbe4a92bf7","count":1}]', 'dba8ac55e7840f591ce3', '2c9bffbb9765135af6eb', '1', '1', 2),
	('92611432c01638b5e106', '[{"pid":"83a8707c684961cabd5f","count":1}]', 'dba8ac55e7840f591ce3', '2c9bffbb9765135af6eb', '98', '1', 2),
	('bf0b0d4a8eaf426d47a2', '[{"pid":"b2771f4cd290d92658e3","count":1}]', 'dba8ac55e7840f591ce3', '2c9bffbb9765135af6eb', '1', '1', 2);
...
INSERT INTO `product` (`pid`, `pname`, `imgUrl`, `sales`, `original_price`, `sale_price`, `mode`, `s_type`, `t_type`, `cid`, `carousel`, `desc`) VALUES
	('044b289fb7d424c5f6ba', '测试商品', 'https://dss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=3510060093,3714106924&fm=26&gp=0.jpg', '9999', '9999', '8888', '直销', 1, 1, NULL, NULL, '测试商品'),
	('0c47869228fabfcd6289', '测试商品', 'https://dss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=3651310629,4261557813&fm=26&gp=0.jpg', '9999', '9999', '8888', '直销', 1, 1, NULL, NULL, '测试商品'),
	('0d8fda0313a3479d318e', '味全每日C', 'https://ms.bdimg.com/dsp-image/3250962582.jpg', '9999', '8.9', '6.9', '直销', 6, 2, NULL, 'http://localhost:7001/public/upload/1dc091a5561e8947dab1477aa490ee6c.jpg', '100%橙汁健康、自然、好喝'),
	('273d7002984bbfe6310f', '测试商品', 'https://img1.360buyimg.com/n6/jfs/t1/143779/18/3061/175039/5f0eab76E1bc8f13f/affc3a65c19d4e23.jpg', '9999', '9999', '8888', '直销', 1, 1, NULL, NULL, '测试商品'),
	('27f3e0b5ab00fae8e0c3', '测试商品', 'https://dss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=3510060093,3714106924&fm=26&gp=0.jpg', '9999', '9999', '8888', '直销', 1, 1, NULL, NULL, '测试商品'),
	('286367aca510dba75b37', '测试商品', 'https://dss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=3651310629,4261557813&fm=26&gp=0.jpg', '1', '666', '555', '直销', 6, 2, NULL, NULL, '好喝'),
	('4a591361f5c7754ac514', '测试商品', 'https://dss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=3510060093,3714106924&fm=26&gp=0.jpg', '9999', '9999', '8888', '直销', 1, 1, NULL, NULL, '测试商品'),
	('4b78068266f52b6ed3a9', '测试商品', 'https://ms.bdimg.com/dsp-image/3250962582.jpg', '9999', '9999', '8888', '直销', 1, 1, NULL, NULL, '测试商品'),
	('74ac9e6091e52c733613', '测试商品', 'https://ms.bdimg.com/dsp-image/3250962582.jpg', '9999', '9999', '8888', '直销', 1, 1, NULL, NULL, '测试商品'),
	('837e29d4ecf6a6e4338e', '测试商品', 'https://ms.bdimg.com/dsp-image/3250962582.jpg', '9999', '9999', '8888', '直销', 1, 1, NULL, NULL, '测试商品'),
	('83a8707c684961cabd5f', '壳牌机油', 'https://dss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=3510060093,3714106924&fm=26&gp=0.jpg', '29999', '120', '98', '自营', 9, 0, NULL, 'http://localhost:7001/public/upload/bf4a4441db926e252b49e2e728dadc41.webp', '大河弯弯向东流，就是这么牛！'),
	('83cd6f94f94aae1945d8', '娃哈哈', 'https://img1.360buyimg.com/n6/jfs/t1/143779/18/3061/175039/5f0eab76E1bc8f13f/affc3a65c19d4e23.jpg', '545555', '555', '1', '代理', 0, 0, NULL, 'http://localhost:7001/public/upload/495ef545b4fef204eb1dd28aa73712cd.webp', '真好喝'),
...
CREATE TABLE IF NOT EXISTS `sort` (
  ...
  PRIMARY KEY  (`sid`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COMMENT='二级分类';

-- 正在导出表  mart.sort 的数据：~23 rows (大约)
DELETE FROM `sort`;
/*!40000 ALTER TABLE `sort` DISABLE KEYS */;
INSERT INTO `sort` (`sid`, `s_type`, `s_text`, `t_type`) VALUES
	(2, 0, '儿童图书', 1),
	(3, 1, '流行小说', 1),
	(4, 2, '艺术文艺', 1),
	(5, 0, '白酒', 2),
...
-- 正在导出表  mart.t_area 的数据：~3,157 rows (大约)
DELETE FROM `t_area`;
/*!40000 ALTER TABLE `t_area` DISABLE KEYS */;
INSERT INTO `t_area` (`areaId`, `areaCode`, `areaName`, `level`, `cityCode`, `center`, `parentId`) VALUES
...
INSERT INTO `user` (`uid`, `nickname`, `graph`, `avatar`, `email`, `mobile`) VALUES
	('415c5c2bb32e40812b01', 'heinan', '企业想真好踏踏实实搞天天作报告公司还好不了。', 'http://localhost:7001/public/upload/6639aa15225f8017710b8317dd11eec7.jpg', '76361506@163.com', '13031061118');
